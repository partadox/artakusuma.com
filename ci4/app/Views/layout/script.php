...
<!-- Digital Clock JS-->
<script src="<?= base_url() ?>/assets_panel/js/clock.js"></script>

<!-- Image Preview Upload Image JS-->
<script src="<?= base_url() ?>/assets_panel/js/upload_image.js"></script>

<!-- Mask Money JS - Format Input Rupiah JS-->
<script src="<?= base_url() ?>/assets_panel/js/jquery.maskMoney.min.js"></script>

<!-- Custom Default Show DataTable-->
<script src="<?= base_url() ?>/assets_panel/js/default_show_dtb.js"></script>
