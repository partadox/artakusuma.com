...
$routes->get('/auth/project', 'Project::index', ['filter' => 'Validasilogin']);
$routes->get('/auth/project/category', 'Project::project_category', ['filter' => 'Validasilogin']);
$routes->get('/auth/profile', 'Profile::index', ['filter' => 'Validasilogin']);

$routes->get('/home/project/(:any)', 'Project::single_project/$1');
